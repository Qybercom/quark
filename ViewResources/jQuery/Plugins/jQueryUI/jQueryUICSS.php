 ...
 */
class jQueryUICSS implements IQuarkSpecifiedViewResource, IQuarkForeignViewResource {
	/**
	...
	public function Location () {
		return 'https://cdnjs.cloudflare.com/ajax/libs/jqueryui/' . $this->_version . '/themes/' . $this->_theme . '/jquery-ui.min.css';
	}
